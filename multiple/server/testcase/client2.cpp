...
forward_list<string> * findAllEmployee()
{
string name;
char c;
...
void getEmployeeList(Request &request, Response &response)
{
char headerBuffer[8192];
forward_list<string>* allName=findAllEmployee();
...
webServer.setPort(7070);
webServer.error404(send404);
webServer.put("/",welcomePage);
webServer.put("employee/list",getEmployeeList);
